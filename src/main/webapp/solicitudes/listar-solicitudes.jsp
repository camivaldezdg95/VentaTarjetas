...
<html>
    ...
    <body>
        ...
        <div class="grid-container">
            ...
            <div class="derecha">            
                <a class="btn btn-danger" href="ControladorSolicitudes?accion=nuevaSolicitud" role="button">Nueva
                    Solicitud</a>
            ...
            <div class="aside">
                <!-- Menu de filtros-->
                <form name="filtros" id="filtros" action="ControladorSolicitudes?accion=Solicitudes&inicio=0" method="POST">
            ...
            <div class="main">
                <table class="table table-striped table-responsive" id="solicitudest">
                    ...
                    <tbody>
                        ...
                        <c:forEach var="solicitud" items="${listasc}">

                            <tr>
                                <td> <c:out value="${solicitud.idSol}"></c:out></td>
                                <td> <c:out value="${solicitud.fecha}"></c:out></td>                          
                                <td> <c:out value="${solicitud.dni}"></c:out></td>
                                <td> <c:out value="${solicitud.nombre}"></c:out></td>
                                <td> <c:out value="${solicitud.vendedor}"></c:out></td>
                                <td> <c:out value="${solicitud.canal}"></c:out></td>
                                <td> <c:out value="${solicitud.sucursal}"></c:out></td>
                                <td> <c:out value="${solicitud.estado}"></c:out></td>                        
                                <td> <a href="ControladorSolicitudes?accion=mostrarSolicitud&id=<c:out value="${solicitud.idSol}"></c:out>"><img src="img/detalles.png" alt="Detalles" title="Detalles" height="30" width="30" /></a>
                                    <a href="ControladorSolicitudes?accion=analizar&id=<c:out value="${solicitud.idSol}"></c:out>"><img src="img/analizar.png" alt="Analizar" title="Analizar" height="30" width="30" /></a>                                                                
                                    </td>
                                </tr>
                        </c:forEach>
                    </tbody>
                ...
                <p> Mostrando desde <c:out value="${(rc==0)? 0: inicio+1}"/> hasta <c:out value="${(inicio+10>rc)? rc: inicio+10}"/> de <c:out value="${rc}" ></c:out> registros</p>
                    ...
                    <nav aria-label="Page navigation example">
                        <ul class="pagination">
                            ...
                            <li class="page-item"> <button class="page-link" onClick="cambiarInicio(0)" style="color: red">Inicio</button></li>

                            <li class="page-item"> <button class="page-link" onClick="cambiarInicio(${(inicio-10<0)? 0: inicio-10})" style="color: red">Anterior</button></li>

                        <li class="page-item"> <button class="page-link" onClick="cambiarInicio(${(inicio+10 >= rc)? inicio: inicio+10})" style="color: red">Siguiente</button></li>

                        <li class="page-item"> <button class="page-link" onClick="cambiarInicio(${(rc-10<0) ? 0: rc-10})" style="color: red" >Final</button></li>
        ...
        <script>
            ...
            function cambiarInicio(nuevoinicio) {
                ...
                formulario.action = "ControladorSolicitudes?accion=Solicitudes&inicio=" + nuevoinicio;
                formulario.submit();
            }
        </script>
